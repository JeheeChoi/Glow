...
This template contains a project, `glow`, and an app, `api`,
...
1. Replace all instances of `glow` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `glow` which should be renamed
...
all instances of `glow` with your app's name.
